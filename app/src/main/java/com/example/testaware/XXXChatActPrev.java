...
public class XXXChatActPrev extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name;
        if(MainActivity.getRole()){
            Log.i(LOG, "Setting name role to Server");
            name = "Server";
        } else {
            Log.i(LOG, "Setting name role to Client");
            name = "Client";
        }
        user= new User(name, myIpvAddr, true);
        peerIpv6 = MainActivity.getPeerIpv6();
        //otherIpAddr = getIntent().getStringExtra()
        //currentUser = new User ("kirsten",getLocalIpV6(), true); //set new userG
